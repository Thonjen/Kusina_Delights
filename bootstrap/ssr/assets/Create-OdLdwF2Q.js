    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(Layout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"${_scopeId}><h1 class="text-3xl font-semibold text-gray-900 mb-8"${_scopeId}>Create New Review</h1><form class="grid grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><label for="user_id" class="block text-gray-700 font-medium"${_scopeId}>User</label><select id="user_id" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:outline-none" required${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></select></div><div${_scopeId}><label for="recipe_id" class="block text-gray-700 font-medium"${_scopeId}>Recipe</label><select id="recipe_id" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:outline-none" required${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></select></div><div${_scopeId}><label for="Star" class="block text-gray-700 font-medium"${_scopeId}>Star Rating</label><input${ssrRenderAttr("value", form.Star)} type="number" id="Star" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:outline-none" min="1" max="5" required${_scopeId}></div><div${_scopeId}><label for="Review" class="block text-gray-700 font-medium"${_scopeId}>Review</label><textarea id="Review" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:outline-none"${_scopeId}>${ssrInterpolate(form.Review)}</textarea></div><div class="col-span-2 flex space-x-3 mt-6"${_scopeId}><button type="submit" class="px-6 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 focus:ring-2 focus:ring-orange-500"${_scopeId}>Save Review</button>`);
            _push2(ssrRenderComponent(_component_inertia_link, {
            ...
            return [
              createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" }, [
                createVNode("h1", { class: "text-3xl font-semibold text-gray-900 mb-8" }, "Create New Review"),
                createVNode("form", {
