      ...
      _push(ssrRenderComponent(Layout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="relative h-screen overflow-hidden" data-v-c687bade${_scopeId}><div class="absolute inset-0 bg-cover bg-center" style="${ssrRenderStyle({ "background-image": "url('https://c.animaapp.com/fvd5j1dy/img/eg4-ep33-leche-flan-67645e919b12432e590b303456de6e74-1.png')" })}" data-v-c687bade${_scopeId}></div><div class="outer-container" data-v-c687bade${_scopeId}><div class="${ssrRenderClass([{ active: isSignUp.value }, "container"])}" data-v-c687bade${_scopeId}><div class="form-container sign-up bg-transparency-100 p-6" data-v-c687bade${_scopeId}><form data-v-c687bade${_scopeId}><h1 class="text-large font-semibold text-center mb-6 text-black-100" data-v-c687bade${_scopeId}> Create Account </h1><input type="text" placeholder="Username" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).name)} required data-v-c687bade${_scopeId}><input type="email" placeholder="Email" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).email)} required data-v-c687bade${_scopeId}><input type="password" placeholder="Password" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).password)} required data-v-c687bade${_scopeId}><input type="password" placeholder="Confirm Password" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).password_confirmation)} required data-v-c687bade${_scopeId}><input type="text" placeholder="First Name" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).FirstName)} data-v-c687bade${_scopeId}><input type="text" placeholder="Middle Name" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).MiddleName)} data-v-c687bade${_scopeId}><input type="text" placeholder="Last Name" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(signupForm).LastName)} data-v-c687bade${_scopeId}><button class="${ssrRenderClass([{ "opacity-25": unref(signupForm).processing }, "bg-light_green-100 hover:bg-light_green-200 text-black-100 font-semibold px-20 py-3 rounded-2xl shadow-md text-small inline-block text-center"])}"${ssrIncludeBooleanAttr(unref(signupForm).processing) ? " disabled" : ""} data-v-c687bade${_scopeId}> Sign Up </button></form></div><div class="form-container sign-in bg-transparency-100 p-6" data-v-c687bade${_scopeId}><form data-v-c687bade${_scopeId}><h1 class="text-large font-semibold text-center mb-6 text-black-100" data-v-c687bade${_scopeId}> Log In </h1><input type="email" placeholder="Email" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(loginForm).email)} required data-v-c687bade${_scopeId}><input type="password" placeholder="Password" class="text-small focus:ring-2 focus:ring-yellow-300"${ssrRenderAttr("value", unref(loginForm).password)} required data-v-c687bade${_scopeId}>`);
            ...
            _push2(`<button class="${ssrRenderClass([{ "opacity-25": unref(loginForm).processing }, "bg-light_green-100 hover:bg-light_green-200 text-black-100 font-semibold px-20 py-3 rounded-2xl shadow-md text-small inline-block text-center mt-4"])}"${ssrIncludeBooleanAttr(unref(loginForm).processing) ? " disabled" : ""} data-v-c687bade${_scopeId}> Log In </button></form></div><div class="toggle-container" data-v-c687bade${_scopeId}><div class="toggle" data-v-c687bade${_scopeId}><div class="toggle-panel toggle-left bg-yellow-300 p-6" data-v-c687bade${_scopeId}><h1 class="text-normal font-bold text-black-100" data-v-c687bade${_scopeId}> Already Have an Account? </h1><p class="text-black-100 text-small font-bold" data-v-c687bade${_scopeId}> Login to find new Opportunities and Discover new Delights </p><button class="bg-light_green-100 hover:bg-light_green-200 text-black-100 font-semibold px-20 py-3 rounded-2xl shadow-md text-small" data-v-c687bade${_scopeId}> Sign In </button></div><div class="toggle-panel toggle-right bg-yellow-300 p-6" data-v-c687bade${_scopeId}><h1 class="text-normal font-bold text-black-100" data-v-c687bade${_scopeId}> Don’t Have an Account? </h1><p class="text-black-100 text-small font-bold" data-v-c687bade${_scopeId}> Sign Up to find new Opportunities and Discover new Delights </p><button class="bg-light_green-100 hover:bg-light_green-200 text-black-100 font-semibold px-20 py-3 rounded-2xl shadow-md text-small" data-v-c687bade${_scopeId}> Sign Up </button></div></div></div></div></div></div>`);
          } else {
            return [
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c687bade"]]);
export {
  Login as default
};
